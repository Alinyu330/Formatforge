...
1. **直接下载安装客户端（APK）**：[FormatForge-v16.apk](https://github.com/Alinyu330/Formatforge/releases/download/backup-20260820-v16/FormatForge-v16.apk)（下载后点击安装，需允许「安装未知来源应用」）
